...
actor EventStore {
    ...
    func append(_ event: ObservabilityEvent) async throws {
    ...
    func recentEvents(limit: Int = 2_000) async throws -> [ObservabilityEvent] {
    ...
    func recentInMemoryEvents(limit: Int = 2_000) async -> [ObservabilityEvent] {
        Array(inMemoryEvents.suffix(limit))
    }

    func pruneExpiredFiles() async throws {
        try pruneExpiredFilesLocked()
    }
