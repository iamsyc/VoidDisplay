...
struct ScreenCatalogSnapshotProvider: ObservabilitySnapshotProvider, @unchecked Sendable {
    nonisolated struct Snapshot: Codable, Equatable, Sendable {
        nonisolated struct LoadError: Codable, Equatable, Sendable {
            let domain: String
            let code: Int
        ...
        nonisolated struct TopologyEntry: Codable, Equatable, Sendable {
