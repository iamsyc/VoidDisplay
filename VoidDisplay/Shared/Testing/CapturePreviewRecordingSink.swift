...
final class CapturePreviewRecordingSink: @unchecked Sendable, DisplayPreviewSink {
...
private struct CapturePreviewRecordedPayload: Codable, Sendable {
    let session: CapturePreviewRecordingMetadata
    let frame: CapturePreviewRecordedFrameMetadata
}
