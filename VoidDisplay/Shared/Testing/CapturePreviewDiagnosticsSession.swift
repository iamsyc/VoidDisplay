...
@MainActor
enum CapturePreviewDiagnosticsBootstrap {
    static func makeMonitoringService(
...
final class UITestCapturePreviewSession: @unchecked Sendable, DisplayCaptureSessioning {
    ...
    init(configuration: CapturePreviewDiagnosticsConfiguration) throws {
...
enum CapturePreviewDiagnosticsError: LocalizedError {
