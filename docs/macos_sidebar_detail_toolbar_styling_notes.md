...
- 主窗口 toolbar 使用系统 scene API：在 [VoidDisplayApp.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Bootstrap/VoidDisplayApp.swift#L31) 上配置 `.windowToolbarStyle(.unified(showsTitle: true))`。
  Use the system scene API for the main window toolbar: configure `.windowToolbarStyle(.unified(showsTitle: true))` in [VoidDisplayApp.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Bootstrap/VoidDisplayApp.swift#L31).
...
- 当前可接受实现位于 [HomeView.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Navigation/HomeView.swift#L24)。
  The accepted implementation lives in [HomeView.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Navigation/HomeView.swift#L24).
...
- 保留 [HomeView.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Navigation/HomeView.swift#L24) 里的 `NavigationSplitView` 和 `List.sidebar`。
  Keep the `NavigationSplitView` and `List.sidebar` in [HomeView.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayApp/Navigation/HomeView.swift#L24).
...
- `appScreenBackground()` 相关实现已经从 [AppUI.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayDesignSystem/Components/AppUI.swift) 清理掉，避免后续误用。
  The `appScreenBackground()` implementation was removed from [AppUI.swift](/Users/syc/Project/VoidDisplay/Sources/VoidDisplayDesignSystem/Components/AppUI.swift) to prevent accidental reuse.

## 6. 验证方法 / Verification Checklist

- 构建：`xcodebuild -project Apps/VoidDisplay/VoidDisplay.xcodeproj -scheme VoidDisplay -configuration Debug -derivedDataPath .ai-tmp/sidebar-toolbar-build/DerivedData build`
  Build: `xcodebuild -project Apps/VoidDisplay/VoidDisplay.xcodeproj -scheme VoidDisplay -configuration Debug -derivedDataPath .ai-tmp/sidebar-toolbar-build/DerivedData build`

- UI smoke：`xcodebuild -project Apps/VoidDisplay/VoidDisplay.xcodeproj -scheme VoidDisplay -configuration Debug -derivedDataPath .ai-tmp/sidebar-toolbar-ui/DerivedData -destination 'platform=macOS,arch=arm64' -only-testing:VoidDisplayUITests/HomeSmokeTests test`
  UI smoke: `xcodebuild -project Apps/VoidDisplay/VoidDisplay.xcodeproj -scheme VoidDisplay -configuration Debug -derivedDataPath .ai-tmp/sidebar-toolbar-ui/DerivedData -destination 'platform=macOS,arch=arm64' -only-testing:VoidDisplayUITests/HomeSmokeTests test`
