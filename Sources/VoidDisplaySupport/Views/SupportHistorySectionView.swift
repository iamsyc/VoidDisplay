...
import SwiftUI
package struct SupportHistorySectionView: View {
    package let records: [SupportExportRecord]
    package let onCopySummary: (UUID) -> Void
    package let onRevealBundle: (UUID) -> Void
