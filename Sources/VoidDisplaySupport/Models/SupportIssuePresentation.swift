...
import Foundation
package nonisolated struct SupportIssuePresentation: Equatable, Sendable {
    package let titleKey: LocalizedStringResource
    package let descriptionKey: LocalizedStringResource
    package let summaryPrefixKey: LocalizedStringResource
    package let recommendedDiagnosticsKey: LocalizedStringResource
    package let symbolName: String
    package let recommendedConsent: FeedbackConsent
}

package extension SupportIssueType {
