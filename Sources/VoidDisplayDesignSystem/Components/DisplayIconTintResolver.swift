...
package enum DisplayIconTintResolver {
    ...
    /// RGB ≈ (0.25, 0.80, 0.55)
    package static let monitoring = Color(red: 0.25, green: 0.80, blue: 0.55).opacity(0.55)
    ...
    package static let monitoringAndSharing = Color(red: 0.7375, green: 0.7025, blue: 0.2575).opacity(0.55)
    ...
    package static func resolve(isMonitoring: Bool, isSharing: Bool) -> Color? {
