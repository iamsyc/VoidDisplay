...
import Foundation
package struct CaptureSnapshotProvider: ObservabilitySnapshotProvider, @unchecked Sendable {
    package nonisolated struct Snapshot: Codable, Equatable, Sendable {
         package nonisolated struct Metrics: Codable, Equatable, Sendable {
         ...
         package nonisolated struct Session: Codable, Equatable, Sendable {
            let id: UUID
