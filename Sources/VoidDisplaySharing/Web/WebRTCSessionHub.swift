...
package final class WebRTCSessionHub: Sendable, DisplayShareFrameConsumer {
    package enum AddClientResult: Sendable, Equatable {
        case accepted(clientID: String)
        case rejected(reason: String)
    }
    package nonisolated struct PeerCallbacks: Sendable {
    ...
    package convenience init() {
        self.init(onDemandChanged: { _ in }, peerFactory: nil)
    }
