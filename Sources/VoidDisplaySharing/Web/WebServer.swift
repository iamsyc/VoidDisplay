...
@MainActor
package final class WebServer {
    private enum InitError: Error {
        case missingDisplayPageResource
    }

    package enum ListenerStartResult {
    ...
    package func startListener(timeout: TimeInterval = 1.5) async -> ListenerStartResult {
    ...
    package func stopListener(reason: WebServiceServerStopReason = .requested) {
