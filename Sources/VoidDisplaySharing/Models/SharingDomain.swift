...
import Foundation
package enum SharePortValidationError: Error, Equatable {
    case empty
    case nonNumeric
    case outOfRange
    ...
    package static func parse(_ rawValue: String) -> Result<UInt16, SharePortValidationError> {
...
package struct WebServiceBinding: Equatable {
    package let requestedPort: UInt16
    package let boundPort: UInt16

    package init(requestedPort: UInt16, boundPort: UInt16) {
        self.requestedPort = requestedPort
        self.boundPort = boundPort
    }
}
package enum WebServiceStartFailure: Error, Equatable {
...
package enum WebServiceStartResult: Equatable {
    ...
    package var failure: WebServiceStartFailure? {
...
package enum WebServiceLifecycleState: Equatable {
    case stopped
