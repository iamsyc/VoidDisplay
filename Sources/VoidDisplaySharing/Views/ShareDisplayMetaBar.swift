...
package struct ShareDisplayMetaBar: View {
    package let displayID: CGDirectDisplayID
    package let displayAddress: String?
    package let displayURL: URL?
    package let displayClientCount: Int
    package let isSharingDisplay: Bool
