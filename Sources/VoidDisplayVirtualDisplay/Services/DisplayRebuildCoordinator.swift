...
@MainActor
package final class DisplayRebuildCoordinator {
    ...
    package func rebuildManagedDisplayFleet(
    ...
    package enum FleetRebuildTeardownStrategy {
        case perDisplaySettlement
        case fleetOfflineOnly
    ...
    package func ensureHealthyTopologyAfterEnable(
