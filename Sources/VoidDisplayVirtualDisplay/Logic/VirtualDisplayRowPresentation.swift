...
import SwiftUI
package struct VirtualDisplayRowPresentation {
    package static func subtitleText(for config: VirtualDisplayConfig) -> String {
    ...
    package static func modeSummary(for config: VirtualDisplayConfig) -> String? {
    ...
    package static func statusLabel(isRunning: Bool, isRebuilding: Bool) -> String {
        if isRebuilding {
    ...
    package static func statusTint(isRunning: Bool, isRebuilding: Bool) -> Color {
        if isRebuilding {
            return .orange
        }
    ...
    package static func badges(rebuildFailureMessage: String?, hasRecentApplySuccess: Bool) -> [AppBadgeModel] {
    ...
    package static func toggleButtonTitle(isRunning: Bool) -> String {
        if isRunning {
            return String(localized: "Disable")
        }
    ...
    package static func restoreFailureSummary(_ failures: [VirtualDisplayRestoreFailure], maxVisible: Int = 3) -> String {
