...
import CoreGraphics
import Foundation
package struct TopologyHealthEvaluation {
    package enum Issue {
    ...
    package let managedDisplayIDs: [CGDirectDisplayID]
    package let forceNormalization: Bool

    package var needsRepair: Bool { issue != nil }
}
package enum TopologyHealthEvaluator {
    ...
    package static func managedDisplayID(
    ...
    package static func selectRepairAnchorDisplayID(
        snapshot: DisplayTopologySnapshot,
    ...
    package static func preferredManagedMainDisplayID(
        snapshot: DisplayTopologySnapshot?
    ) -> CGDirectDisplayID? {
        guard let snapshot,
    ...
    package static func shouldEnforceMainContinuity(
