...
package enum AspectRatio: String, CaseIterable, Identifiable {
    ...
    package var components: (width: Double, height: Double) {
        switch self {
    ...
    package func sizeInMillimeters(diagonalInches: Double) -> (width: Int, height: Int) {
        let (w, h) = components
...
package struct DisplayCalculator {
    
    /// Calculate physical pixels based on logical resolution and HiDPI setting
    package static func physicalPixels(logicalWidth: Int, logicalHeight: Int, hiDPI: Bool) -> (width: Int, height: Int) {
