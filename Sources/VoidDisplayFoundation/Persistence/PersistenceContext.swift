import Foundation
import OSLog
package enum PersistenceMode: Equatable {
    case production
    case testIsolatedWritable
}
package enum PersistenceWriteViolation: Error, Equatable {
    case blockedProductionWrite(path: String, operation: String)
}
package struct PersistenceContext {
    package static let xCTestConfigurationEnvironmentKey = "XCTestConfigurationFilePath"
    package static let uiTestModeEnvironmentKey = "VOIDDISPLAY_UI_TEST_MODE"
    package static let testIsolationIDEnvironmentKey = "VOIDDISPLAY_TEST_ISOLATION_ID"
    package static let persistenceModeEnvironmentKey = "VOIDDISPLAY_PERSISTENCE_MODE"
    package static let testIsolatedModeValue = "test_isolated"
    package static let defaultBundleIdentifier = "com.developerchen.voiddisplay"

    package let mode: PersistenceMode
    package let bundleIdentifier: String
    package let appSupportRootURL: URL
    package let displayShareIDMappingsURL: URL
    package let virtualDisplayConfigsURL: URL
    ...
    package static func resolveMode(environment: [String: String]) -> PersistenceMode {
    ...
    package func guardWriteAllowed(
        targetURL: URL,
        ...
        Logger(
            subsystem: Bundle.main.bundleIdentifier ?? Self.defaultBundleIdentifier,
